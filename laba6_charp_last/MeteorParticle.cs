...
namespace laba6_charp_last
{
    public class MeteorParticle : TargetParticle
    {
        ...
        private static Size meteorSize = new Size(60, 60); // Уменьшенный размер
        ...
        static MeteorParticle()
        {
            try
            {
                var originalImage = Image.FromFile("Resources/meteor.png"); // Убедитесь в правильном имени файла
